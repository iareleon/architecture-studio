...
- **Goal:** Ensure the workspace adheres to the `FIRST-BRAIN.md` governance rules and folder structure.
- **Rules:**
  ...
  - Use `llm/install.json` to warn if the structure differs from the original install, only considering the original install configuration.
